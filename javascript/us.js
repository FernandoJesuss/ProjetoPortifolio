$(function() {
    $(".en").click(function() {
        ...
        $(".ul-menu li:nth-child(2) a").text("About")
        $(".ul-menu li:nth-child(3) a").text("Services")
        $(".ul-menu li:nth-child(4) a").text("Skills")
        $(".ul-menu li:nth-child(5) a").text("Portfolio")
        $(".ul-menu li:nth-child(6) a").text("Contact")
        $(".language-selected").text("en-US")
        $(".language-selected").removeClass("change-br")
        $(".language-selected").addClass("change-en")
        //home
        $(".home-presentation p:nth-child(1)").text("Hello! I am,")
        $(".home-presentation h1:nth-child(2)").text("My name is")
        $(".home-presentation h1:nth-child(3)").text("Fernando Santos")
        $(".home-presentation p:nth-child(4)").text("At 36, I am experiencing an exciting career transition.")
        $(".home-presentation p:nth-child(5)").text("I left behind the support analysis area and am now immersed in the world of programming.")
        $(".home-presentation p:nth-child(6)").text("I have a burning passion for technology and am eager to contribute innovative solutions in this field.")
        $(".home-presentation p:nth-child(7)").text("If you need more information or have any other questions, I am at your disposal!")


 //about
$(".about h1").text("About")
$(".text-about p:nth-child(1)").text("I am a Front-End Developer with a degree in Information Systems and experience in web systems maintenance. My passion for technology motivates me to constantly seek to improve my technical skills.")

$(".text-about p:nth-child(2)").text("During my previous career, I developed strong problem-solving, data analysis, and teamwork skills. These skills are highly transferable to programming, where I can apply my ability to solve complex challenges and collaborate on exciting projects.")


$(".text-about p:nth-child(3)").text("I am currently studying Full Stack training at DevClub. I am always looking for practical projects to apply my knowledge and further improve my technical skills. If you are looking for a committed, passionate developer who is ready to take on new challenges, I am available!")
        ...
        //skilss
        $(".skills span").text("TECHNICAL AND PROFESSIONAL")
